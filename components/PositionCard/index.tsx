          ...
          <AutoColumn gap="8px">
            ...
            <RowBetween marginTop="10px">
              <Button style={{ width: '48%' }}>
                <Link href={`/AddLiquidity/${currencyId(currency0)}/${currencyId(currency1)}`}>Add</Link>
              </Button>
              <Button
                style={{ width: '48%' }}
              >
                <Link href={`/RemoveLiquidity/${currencyId(currency0)}/${currencyId(currency1)}`}>Remove</Link>
              </Button>
            </RowBetween>
          </AutoColumn>
        )}
