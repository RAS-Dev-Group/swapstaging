...
export function CurrencySearch({
  ...
  const tokensBySelect = Object.values(allTokens).filter((token) =>
    selectedCurrency.symbol === 'YLT' ? token.address === process.env.NEXT_PUBLIC_YLTtokenAddress : token.address !== process.env.NEXT_PUBLIC_YLTtokenAddress
  )
  ...
  const filteredTokens: Token[] = useMemo(() => {
    ...
    return filterTokens(Object.values(tokensBySelect), searchQuery)
  }, [isAddressSearch, searchToken, tokensBySelect, searchQuery])
